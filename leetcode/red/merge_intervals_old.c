 ...
 *
 * use an array to represent the numbers and calculate the intervals at last
 *
 *insert intervals: use binary search to find the position. check the front and back one to see if need merge
 *
 * */
